RoomSetData.G =
{
	...
	G_Reprieve01 =
	{
		...
		HarvestPointChances = { @harvest_chance|0.6@, @harvest_chance|0.4@, },
	...
	G_Story01 =
	{
		...
		HarvestPointChances = { @harvest_chance|0.5@, @harvest_chance|0.1@, },
		ShovelPointChance = @shovel_chance|0.4@,
		PickaxePointChance = @pickaxe_chance|0.4@,
		ExorcismPointChance = @exorcism_chance|0.4@,
		FishingPointChance = @fishing_chance|0.1@,
