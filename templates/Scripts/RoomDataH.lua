RoomSetData.H =
{
	BaseH =
	{
		...
		HarvestPointChances = { @harvest_chance|0.30@, },
		ShovelPointChance = @shovel_chance|0.24@,
		PickaxePointChance = @pickaxe_chance|0.36@,
		ExorcismPointChance = @exorcism_chance|0.24@,
		FishingPointChance = @fishing_chance|0.18@,
		...
		{
			{
				SumPrevRooms = @harvest_distance|1@,
		...
		ShovelPointRequirements =
		{
			...
			{
				SumPrevRooms = @shovel_distance|2@,
		...
		PickaxePointRequirements =
		{
			...
			{
				SumPrevRooms = @pickaxe_distance|2@,
				Path = { "NumPickaxePoints" },
				Comparison = "<=",
				Value = 0,
			},
		...
		ExorcismPointRequirements =
		{
			...
			{
				SumPrevRooms = @exorcism_distance|2@,
				Path = { "NumExorcismPoints" },
				Comparison = "<=",
				Value = 0,
			},
		...
		FishingPointRequirements =
		{
			...
			{
				SumPrevRooms = @fishing_distance|2@,
				Path = { "NumFishingPoints" },
				Comparison = "<=",
				Value = 0,
			},
	...
	H_Bridge01 =
	{
		...
		HarvestPointChances = { @harvest_chance|0.75@ },
		ShovelPointChance = @shovel_chance|0.5@,
		PickaxePointChance = @pickaxe_chance|0.5@,
		ExorcismPointChance = @exorcism_chance|0.5@,
		FishingPointChance = @fishing_chance|0.5@,
	...
	H_MiniBoss01 =
	{
		...
		ShovelPointChance = @shovel_chance|0.5@,
		PickaxePointChance = @pickaxe_chance|0.45@,
		ExorcismPointChance = @exorcism_chance|0.40@,
	...
	H_PreBoss01 =
	{
		...
		HarvestPointChances = { @harvest_chance|0.33@ },
		ShovelPointChance = @shovel_chance|0.33@,
		PickaxePointChance = @pickaxe_chance|0.33@,
		ExorcismPointChance = @exorcism_chance|0.33@,
		FishingPointChance = @fishing_chance|0.33@,
