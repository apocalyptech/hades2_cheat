EncounterSets =
{
	...
	FEncountersDefault =
	{
		...
		"@nemesis_encounter_weight|NemesisCombatF@",
		"NemesisRandomEvent", 
		"@nemesis_encounter_weight|NemesisRandomEvent@",
	...
	OEncountersDefault =
	{
		...
		"@icarus_encounter_weight|IcarusCombatO@",

		"IcarusCombatO2",
		"IcarusCombatO2",
		"IcarusCombatO2",
		"@icarus_encounter_weight|IcarusCombatO2@",
