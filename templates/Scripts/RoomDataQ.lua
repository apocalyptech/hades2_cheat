RoomSetData.Q =
{
	BaseQ =
	{
		...
		ShovelPointChance = @shovel_chance|0.10@,
		PickaxePointChance = @pickaxe_chance|0.10@,
		ExorcismPointChance = @exorcism_chance|0.05@,
		FishingPointChance = @fishing_chance|0.15@,
	...
	Q_Intro =
	{
		...
		ExorcismPointChance = @exorcism_chance|0.02@,
	...
	Q_MiniBoss03 =
	{
		...
		HarvestPointChances = { @harvest_chance|0.3@, },
		ShovelPointChance = @shovel_chance|0.3@,
		PickaxePointChance = @pickaxe_chance|0.3@,
		ExorcismPointChance = @exorcism_chance|0.15@,
		FishingPointChance = @fishing_chance|0.45@,
