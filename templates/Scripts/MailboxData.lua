	...
	{
		{
			...
			{ 
				...
				DeliveryTimeMin = @charon_stash_delivery_scale|20@,
				DeliveryTimeMax = @charon_stash_delivery_scale|20@,
				Cost =
				{
					CharonPoints = 1,
				},
			...
			{ 
				...
				DeliveryTimeMin = @charon_stash_delivery_scale|30@,
				DeliveryTimeMax = @charon_stash_delivery_scale|30@,
				Cost =
				{
					CharonPoints = 2,
				},
			...
			{ 
				...
				DeliveryTimeMin = @charon_stash_delivery_scale|40@,
				DeliveryTimeMax = @charon_stash_delivery_scale|40@,
				Cost =
				{
					CharonPoints = 3,
				},
			...
			{ 
				...
				DeliveryTimeMin = @charon_stash_delivery_scale|60@,
				DeliveryTimeMax = @charon_stash_delivery_scale|60@,
				Cost =
				{
					CharonPoints = 4,
				},
			...
			{ 
				...
				DeliveryTimeMin = @charon_stash_delivery_scale|100@,
				DeliveryTimeMax = @charon_stash_delivery_scale|100@,
				Cost =
				{
					CharonPoints = 5,
				},
