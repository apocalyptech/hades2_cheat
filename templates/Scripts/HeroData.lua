HeroData =
{
	...
	EasyModeDamageMultiplierBase = @godmode_start_pct|0.8@,
	EasyModeDamageMultiplierPerDeath = @godmode_per_death|-0.02@,
	EasyModeDamageMultiplierDeathCap = @godmode_death_cap|30@,
