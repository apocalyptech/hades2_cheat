WorldUpgradeData =
{
	...
	WorldUpgradeMixerShadow =
	{
		...
		CookTime = @cauldron_cook_scale|12@,
		Repeatable = true,
		SkipUnlockText = true,
		UnlockTextId = "RepeatableUnlock",
		OnActivateFinishedFunctionName = "ResourceGiftedPresentation",
	...
	WorldUpgradeFamiliarPoints =
	{
		...
		CookTime = @cauldron_cook_scale|14@,
		Repeatable = true,
		SkipUnlockText = true,
		UnlockTextId = "RepeatableUnlock",
		OnActivateFinishedFunctionName = "ResourceGiftedPresentation",
	...
	WorldUpgradeCardUpgradePoints2 =
	{
		...
		CookTime = @cauldron_cook_scale|4@,
		Repeatable = true,
		SkipUnlockText = true,
		UnlockTextId = "RepeatableUnlock",
		OnActivateFinishedFunctionName = "ResourceGiftedPresentation",
	...
	WorldUpgradeNectar =
	{
		...
		CookTime = @cauldron_cook_scale|8@,
		Repeatable = true,
		SkipUnlockText = true,
		UnlockTextId = "RepeatableUnlock",
		OnActivateFinishedFunctionName = "ResourceGiftedPresentation",
	...
	WorldUpgradeAmbrosia =
	{
		...
		CookTime = @cauldron_cook_scale|16@,
		Repeatable = true,
		SkipUnlockText = true,
		UnlockTextId = "RepeatableUnlock",
		OnActivateFinishedFunctionName = "ResourceGiftedPresentation",
	...
	WorldUpgradeReviveIcarus =
	{
		...
		CookTime = @cauldron_cook_scale|32@,
		-- Repeatable = true,
		-- SkipUnlockText = true,
		UnlockTextId = "RepeatableUnlock",
		IgnoreAffordable = true,
