NamedRequirementsData =
{
	...
	{
		{
			SumPrevRooms = @nemesis_min_room_distance|99@,
		...
		{
			SumPrevRooms = @nemesis_min_room_distance|12@,
	...
	{
		{
			SumPrevRooms = @npc_min_room_distance|6@,
			Path = { "EncountersOccurredCache", },
			TableValuesToCount =
			{
				"ArtemisCombatIntro",
	...
	{
		{
			...
			Min = @becoming_closer_min_runs|3@ },
		},
		{
			FunctionName = "RequireRunsSinceTextLines",
			FunctionArgs = { TextLines =
			...
			Min = @becoming_closer_min_runs|9@ },
		},
	},
