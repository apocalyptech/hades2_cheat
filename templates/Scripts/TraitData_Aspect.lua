TraitSetData.Aspects =
{
			...
			WeaponStaffBall =
			{
				...
				ChargeWeaponStages = 
				{
					{ 
						...
						{
							DamageRadius = 435,
							Damage = @weapon_damage_scale|110@,
						},
	...
	DaggerTripleAspect =
	{
		...
		PropertyChanges =
		{
			...
			},
			{
				...
				ChangeValue = @weapon_damage_scale|50@,
			},
			{
				WeaponName = "WeaponDaggerDash",
				ExcludeLinked = true,
			...
			},
			{
				...
				ExcludeLinked = true,
				ProjectileProperty = "Damage",
				ChangeValue = @weapon_damage_scale|30@,
			},
			{
				WeaponName = "WeaponDaggerDouble",
				ExcludeLinked = true,
				ProjectileProperty = "Damage",
				ChangeValue = @weapon_damage_scale|40@,
			},
		},
		StatLines = 
		{
	...
	TorchSprintRecallAspect = 
	{
		...
		AddOutgoingDamageModifiers = 
		{
			...
			{ 
				BaseValue = @weapon_damage_scale|25@,
			},
			ReportValues = 
			{ 
	...
	AxeRecoveryAspect = 
	{
		...
		{
			ValidWeapons = WeaponSets.HeroPrimaryWeapons,
			NonExBaseDamageAddition = { BaseValue = @weapon_damage_scale|30@ },
			ReportValues = 
			{ 
