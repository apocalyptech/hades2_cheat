RoomSetData.P =
{
	...
	P_Reprieve01 =
	{
		...
		HarvestPointChances = { @harvest_chance|0.5@, @harvest_chance|0.3@, },
		ShovelPointChance = @shovel_chance|0.20@,
		PickaxePointChance = @pickaxe_chance|0.30@,
		ExorcismPointChance = @exorcism_chance|0.20@,
